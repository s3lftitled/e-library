...
router.get('/get-statistics', verifyToken, (req, res) => getLibraryStatistics(req, res, userRepository))

// Endpoint to get daily, weekly, and monthly visitors along with their programs
router.get('/api/visitors', verifyToken, (req, res) => visitorStatistics(req, res, visitorRepository))
