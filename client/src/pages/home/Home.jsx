      ...
      <div className='home-container'>
        ...
        <div className='introduction-section'>
          <div className='welcome-greetings'>
            ...
            <dotlottie-player src="https://lottie.host/c7b8849d-1b44-4cb0-a68f-6874fbafe0f3/AJYxlq4Zs0.json" background="transparent" speed="1" style={{ width: "200px", height: "200px" }} loop autoplay></dotlottie-player>  
        </div>
